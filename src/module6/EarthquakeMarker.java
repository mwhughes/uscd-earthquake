...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	public int compareTo(EarthquakeMarker o)
	{
		...
		float oMag = o.getMagnitude();
		if (thisMag<oMag){ return 1;}
		else if (thisMag>oMag){return -1;}
		else { return 0;}
	}
	...
	public void drawMarker(PGraphics pg, float x, float y) {
		...
		//determine whether the marker is being displayed as nearest marker
		if (this.getWhetherisNearest())
		{
			
			if (this.getDistanceNearest()<=this.threatCircle())
			{
